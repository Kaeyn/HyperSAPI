...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowSpecificOrigins",
        builder => builder.WithOrigins("http://localhost:4200", "https://hypers-32a8f.web.app", "https://hypers-fe.onrender.com", "https://hypershop.online", "https://hypershop-scys.onrender.com")
